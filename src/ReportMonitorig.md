...
Напишем bash-скрипт. Скрипт запускается с одним параметром. Параметр текстовый.
...
Напишем bash-скрипт. Скрипт должен вывести на экран информацию в виде:
...
Напишем bash-скрипт. За основу взят скрипт из [**Part 2**]
...
Напишем bash-скрипт. За основу возьмем скрипт из [**Part 3**]. Обозначения цветов аналогичные.  
...
Напишем bash-скрипт. Скрипт запускается с одним параметром.  
